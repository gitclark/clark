 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://webservice.com/", wsdlLocation = "http://localhost:7777/tudou?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/tudou?wsdl");
    ...
    public IMyservice getMyServiceImplPort() {
        return super.getPort(new QName("http://webservice.com/", "MyServiceImplPort"), IMyservice.class);
    }
    ...
    public IMyservice getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com/", "MyServiceImplPort"), IMyservice.class, features);
    }
