...
public class ObjectFactory {
    ...
    private final static QName _MinusResponse_QNAME = new QName("http://webservice.com/", "minusResponse");
    private final static QName _AddResponse_QNAME = new QName("http://webservice.com/", "addResponse");
    private final static QName _Minus_QNAME = new QName("http://webservice.com/", "minus");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "minusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.com/", name = "minus")
